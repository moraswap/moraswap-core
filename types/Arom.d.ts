...
interface AromInterface extends ethers.utils.Interface {
  functions: {
    "DELEGATION_TYPEHASH()": FunctionFragment;
    "DOMAIN_TYPEHASH()": FunctionFragment;
    "allowance(address,address)": FunctionFragment;
    "approve(address,uint256)": FunctionFragment;
    "aromForMora(uint256)": FunctionFragment;
    ...
    "moraForArom(uint256)": FunctionFragment;
...
export class Arom extends Contract {
  ...
  functions: {
    ...
    moraForArom(
      ...
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { aromAmount: BigNumber }>;
